function openModal_funcionario(id_funcionario, data, idModal) {
    var dialog = document.getElementById(idModal);
    dialog.style.opacity = 1;
    dialog.style.pointerEvents = "auto";
    loadContent('funcionario_dia', "./relatorios/funcionario/detalhamento_dia.php?id_funcionario=" + id_funcionario + "&data=" + data);
}
