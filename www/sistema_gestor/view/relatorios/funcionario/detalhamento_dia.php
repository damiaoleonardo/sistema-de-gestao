        ...
        <div class="geral_relatorio_funcionario">
            ...
            <div class="contans" style="" >
                <table class="table table-hover">
                    ...
                    /*    $sql_tipo_tarefa = "SELECT  tarefas_executa.tipo_tarefa  FROM `tarefas_executa` JOIN `funcionario_executa`ON ( tarefas_executa.id_tarefa = funcionario_executa.id_tarefa )
                      WHERE funcionario_executa.id_funcionario = 2
                      AND funcionario_executa.data_tarefa = '2016-06-17' order by funcionario_executa.hora_inicial asc";
                      $result_tipo_tarefa = mysql_query($sql_tipo_tarefa);
                      while($aux_result_tipo_tarefa = mysql_fetch_array($result_tipo_tarefa)){
                      echo   $tipo_da_tarefa = $aux_result_tipo_tarefa['tipo_tarefa'];
                    ...
                    while ($aux_dia_a_dia_do_funcionario = mysql_fetch_array($result_dia_a_dia_do_funcionario)) {
                        $codigo_funcionario_executa = $aux_dia_a_dia_do_funcionario['codigo'];
                        ...
                        if ($flag_tarefa_relatorio != 1) {
                            ...
                            <tr>
                                ...
                                ?>
                                <td style="height: 50px; background: #67b168; color:white;  font-size: 0.9em; "><?php echo $ultima_atualizacao ?></td>
                                ...
                                <td style="height: 50px; background: #67b168; color:white;   font-size:  0.9em; "><?php echo $hora_inicial_tarefa ?></td>
                                <td colspan="4" style="font-size:  0.9em; background: #E38585; color:white; "> TEMPO INATIVO = <?php echo $hora_concluidas ?></td>
                            ...
                            <tr>
                                ...
                                ?>
                                <td style="height: 50px;background: #67b168; color:white;   font-size: 1em;"><?php echo $hora_inicial_tarefa ?></td>
                                ...
                                <td style="height: 50px; background: #67b168; color:white;   font-size: 1em;"><?php echo $hora_final_tarefa ?></td>
                                <td style="font-size:  0.9em; background: #67b168; color:white;"><?php echo $horas_concluidas ?></td>
                                <td style="font-size:  0.9em; background: #67b168; color:white;"><?php echo $duracao_tarefa ?></td>
                                <td style="font-size:  0.9em; background: #67b168; color:white;"><?php echo $nome_veiculo ?></td>
                                <td style="font-size:  0.9em; background: #67b168; color:white;">
                                    <table>

                                        <?php
                                        $descricao_da_tarefa = "SELECT descricao_tarefa.descricao  FROM `descricao_tarefa` JOIN `funcionario_executa` ON (funcionario_executa.codigo = descricao_tarefa.id_codigo_funcionario and funcionario_executa.id_projeto_executa = descricao_tarefa.id_projeto_executa and funcionario_executa.id_projeto = descricao_tarefa.id_projeto and funcionario_executa.id_veiculo = descricao_tarefa.id_veiculo and descricao_tarefa.id_tarefa = descricao_tarefa.id_tarefa and funcionario_executa.id_funcionario = descricao_tarefa.id_funcionario )
                                              WHERE funcionario_executa.id_funcionario =$id_do_funcionario_especifico and funcionario_executa.codigo = $codigo_funcionario_executa
                                              AND funcionario_executa.data_tarefa = '$data_selecionada_para_consulta' order by funcionario_executa.hora_inicial asc";
                                        $result_descricao = mysql_query($descricao_da_tarefa);
                                        while ($aux_descricao_tarefa = mysql_fetch_array($result_descricao)) {
                                            $descricao_tarefa = $aux_descricao_tarefa['descricao'];
                                            $arquivo = explode('.', $descricao_tarefa);
                                            $extensao = $arquivo[1];
                                            if ($extensao == 'jpg') {
                                                ?>
                                                <tr>
                                                <td><a href="http://localhost/sistema_gestor/descricao_das_tarefas/<?php echo $data_selecionada_para_consulta ?>/+<?php echo $descricao_tarefa ?>" target="_blank">
                                                <img title="FRASE" alt="Imagem" src=""/></a></td>
                                               </tr>  
                                             <?php
                                            }else {
                                                ?>
                                               <audio controls="controls" loop  preload="preload" title="Abaçaiado">
                                                  
                                                   <source type="audio/mp3" src="" /> <a href="http://localhost/sistema_gestor/descricao_das_tarefas/<?php echo $data_selecionada_para_consulta ?>/+<?php echo $descricao_tarefa ?>">Audio</a> </audio>
