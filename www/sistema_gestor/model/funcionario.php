...
class funcionario {
    private $id_funcionario; private $nome; private $login; private $senha; private $sobrenome;private $endereco;
    private $data_nascimento; private $bairro;  private $cep;  private $cidade; private $rg; private $cpf; private $tipo;private $uf;private $celular;
    ...
    function AddFuncionario(funcionario $obj) {
        $login = $obj->getLogin();  $senha = $obj->getSenha(); $nome = $obj->getNome();
    ...
    function AtualizaDados(funcionario $obj) {
        $id = $obj->getId_funcionario(); $login = $obj->getLogin();$senha = $obj->getSenha();
        $nome = $obj->getNome();  $sobrenome = $obj->getSobrenome(); $endereco = $obj->getEndereco();
        $data_nascimento = $obj->getData_nascimento();
        $bairro = $obj->getBairro(); $cep = $obj->getCep(); $cidade = $obj->getCidade(); $rg = $obj->getRg();
        $cpf = $obj->getCpf(); $tipo = $obj->getTipo();
        $uf = $obj->getUf();$celular = $obj->getCelular();
