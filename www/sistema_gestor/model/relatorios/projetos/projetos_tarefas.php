...
class projetos_tarefas {
    ...
    function projetos(projetos_tarefas $obj) {
        $id_projeto = $obj->getId_projeto();
        $sql = "SELECT DISTINCT projeto_executa.id_projeto_executa,projeto_executa.id_projeto,projeto_executa.id_veiculo,projeto_executa.nome_projeto,projeto_executa.nome_veiculo,projeto_executa.data_inicio,projeto_executa.data_final,projeto_executa.data_inicio,projeto_executa.horas_concluidas,projeto_executa.duracao from projeto_executa join tarefas_executa on (projeto_executa.id_projeto_executa = tarefas_executa.id_projeto_executa and projeto_executa.id_projeto = tarefas_executa.id_projeto 
        and projeto_executa.id_veiculo = tarefas_executa.id_veiculo) where projeto_executa.id_projeto = $id_projeto and projeto_executa.status = 'concluido' ";
        return $sql;
    }
    ...
    function projetosDatas(projetos_tarefas $obj) {
        ...
        $sql = "SELECT DISTINCT projeto_executa.id_projeto_executa,projeto_executa.id_projeto,projeto_executa.id_veiculo,projeto_executa.nome_projeto,projeto_executa.nome_veiculo,projeto_executa.data_inicio,projeto_executa.data_final,projeto_executa.data_inicio,projeto_executa.horas_concluidas,projeto_executa.duracao from projeto_executa join tarefas_executa on (projeto_executa.id_projeto_executa = tarefas_executa.id_projeto_executa and projeto_executa.id_projeto = tarefas_executa.id_projeto and projeto_executa.id_veiculo = tarefas_executa.id_veiculo) where projeto_executa.id_projeto = $id_projeto and projeto_executa.data_inicio >= '$data_inicio' and projeto_executa.data_final <= '$data_final' and projeto_executa.status = 'concluido'  ";
        return $sql;
    }
     function veiculos(projetos_tarefas $obj) {
        $id_veiculo = $obj->getId_veiculo();
        $sql = "SELECT DISTINCT projeto_executa.id_projeto_executa,projeto_executa.id_projeto,projeto_executa.id_veiculo,projeto_executa.nome_projeto,projeto_executa.nome_veiculo,projeto_executa.data_inicio,projeto_executa.data_final,projeto_executa.data_inicio,projeto_executa.horas_concluidas,projeto_executa.duracao from projeto_executa join tarefas_executa on (projeto_executa.id_projeto_executa = tarefas_executa.id_projeto_executa and projeto_executa.id_projeto = tarefas_executa.id_projeto 
        and projeto_executa.id_veiculo = tarefas_executa.id_veiculo) where projeto_executa.id_veiculo = $id_veiculo and projeto_executa.status = 'concluido' ";
        return $sql;
    }
    ...
    function projetosVeiculos(projetos_tarefas $obj) {
        ...
        $id_veiculo = $obj->getId_veiculo();
        $sql = "SELECT DISTINCT projeto_executa.id_projeto_executa,projeto_executa.id_projeto,projeto_executa.id_veiculo,projeto_executa.nome_projeto,projeto_executa.nome_veiculo,projeto_executa.data_inicio,projeto_executa.data_final,projeto_executa.data_inicio,projeto_executa.horas_concluidas,projeto_executa.duracao from projeto_executa join tarefas_executa on (projeto_executa.id_projeto_executa = tarefas_executa.id_projeto_executa and projeto_executa.id_projeto = tarefas_executa.id_projeto 
        and projeto_executa.id_veiculo = tarefas_executa.id_veiculo) where projeto_executa.id_projeto = $id_projeto and projeto_executa.id_veiculo = $id_veiculo and projeto_executa.status = 'concluido' ";
        return $sql;
    }
     function projetosVeiculosDatas(projetos_tarefas $obj) {
        ...
        $data_final = $obj->getData_final();
        $sql = "SELECT DISTINCT projeto_executa.id_projeto_executa,projeto_executa.id_projeto,projeto_executa.id_veiculo,projeto_executa.nome_projeto,projeto_executa.nome_veiculo,projeto_executa.data_inicio,projeto_executa.data_final,projeto_executa.data_inicio,projeto_executa.horas_concluidas,projeto_executa.duracao from projeto_executa join tarefas_executa on (projeto_executa.id_projeto_executa = tarefas_executa.id_projeto_executa and projeto_executa.id_projeto = tarefas_executa.id_projeto 
        and projeto_executa.id_veiculo = tarefas_executa.id_veiculo) where projeto_executa.id_projeto = $id_projeto and projeto_executa.id_veiculo = $id_veiculo and projeto_executa.data_inicio >= '$data_inicio' and projeto_executa.data_final <= '$data_final' and projeto_executa.status = 'concluido' ";
        return $sql;
    }
