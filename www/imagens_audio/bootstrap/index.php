...
<body>
<div class="container">
    <form id="fileupload" action="localhost/imagens_audio/bootstrap/" method="POST" enctype="multipart/form-data">
        <noscript><input type="hidden" name="redirect" value="localhost/imagens_audio/bootstrap/"></noscript>
