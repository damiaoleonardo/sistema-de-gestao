...
class PHPlot {
    ...
    var $safe_margin = 10;               // Extra margin used in several places. In pixels
...
//Data
    ...
    var $group_frac_width = 1.1;            // Bars use this fraction (0 to 1) of a group's space
    var $bar_extra_space = 0.7;             // Number of extra bar's worth of space in a group
...
//Ticks
    ...
    var $y_tick_inc = '1';                   // Set num_y_ticks or y_tick_inc, not both.
...
//////////////////////////////////////////////////////
     ...
     */
    function PHPlot($which_width=700, $which_height=400, $which_output_file=NULL, $which_input_file=NULL)
    {
