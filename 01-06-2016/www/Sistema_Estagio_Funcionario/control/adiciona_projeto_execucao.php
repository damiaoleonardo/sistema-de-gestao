<?php
$id_do_veiculo = $_POST['veiculo'];
$id_do_projeto = $_POST['projeto'];

if (empty($id_do_veiculo) || empty($id_do_projeto)) {
...
if ($cont_veiculos_iguais > 0) {
    ...
    echo "<script>location.href='../view/tela_principal.php?t=visualiza_projeto&login=$login_funcionario'</script>";
}
