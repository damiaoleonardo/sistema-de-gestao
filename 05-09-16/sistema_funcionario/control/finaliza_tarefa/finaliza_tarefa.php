...
$quantidades_executores_finaliza_projeto = mysqli_num_rows($query_id_tarefa_finaliza);
    if ($quantidades_executores_finaliza == 1) {
        $atualiza_tarefa = "UPDATE tarefas_executa SET status = 'concluida', horas_final = '$horaatual', data_final= '$data_atual' where tarefas_executa.id_projeto_executa = $id_projeto_executa_stop and tarefas_executa.id_projeto = $id_projeto_stop and tarefas_executa.id_veiculo= $id_veiculo_stop and tarefas_executa.id_tarefa = $id_tarefa_stop and tarefas_executa.conclusao_projeto = 'nao concluido'";
