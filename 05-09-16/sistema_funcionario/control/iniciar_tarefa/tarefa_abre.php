...
if ($id_do_status_do_funcionario == $id_funcionario_varios_executores) {
    ...
    if ($data_da_tarefa_abre == $dataatual) {
        ...
        $query_verifica_registro = "select funcionario_executa.codigo from funcionario_executa where funcionario_executa.id_projeto_executa = $id_projeto_executa_varios_executores and funcionario_executa.id_projeto = $id_projeto_varios_executores and funcionario_executa.id_veiculo = $veiculo_varios_executores  and funcionario_executa.id_tarefa = $id_tarefa_varios_executores and funcionario_executa.id_funcionario = $id_funcionario_varios_executores and funcionario_executa.status_tarefa = 'open' and funcionario_executa.status_funcionario_tarefa = 'ativo' ";
        $query_verifica = mysqli_query($conexao_select_reabre_tarefa, $query_verifica_registro);
        if (!$query_verifica) {
            $erro_select_inicia++;
        }
