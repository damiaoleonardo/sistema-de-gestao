...
$query_verifica_registro = "select funcionario_executa.codigo from funcionario_executa where funcionario_executa.id_projeto_executa = $id_projeto_executa_inicia and funcionario_executa.id_projeto = $id_projeto_inicia and funcionario_executa.id_veiculo = $id_veiculo_inicia  and funcionario_executa.id_tarefa = $id_tarefa_inicia and funcionario_executa.id_funcionario = $id_funcionario_inicia and funcionario_executa.status_tarefa = 'open' and funcionario_executa.status_funcionario_tarefa = 'ativo' ";
$query_verifica = mysqli_query($conexao_select_inicia, $query_verifica_registro);
 if (!$query_verifica) {
   $erro_select_inicia++;
   }
