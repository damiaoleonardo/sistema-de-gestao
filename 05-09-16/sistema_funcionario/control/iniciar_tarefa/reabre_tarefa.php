...
if ($id_do_status_do_funci == $id_funcionario_retorna_pausada){
    if ($data_da_tarefa == $data_hoje) {
        ...
        $query_verifica_registro = "select funcionario_executa.codigo from funcionario_executa where funcionario_executa.id_projeto_executa = $id_projeto_executa_retorna_pausada and funcionario_executa.id_projeto = $id_projeto_pausado_retorna_pausada and funcionario_executa.id_veiculo = $id_veiculo_pausado_retorna_pausada  and funcionario_executa.id_tarefa = $id_tarefa_pausada_retorna_pausada and funcionario_executa.id_funcionario = $id_funcionario_retorna_pausada and funcionario_executa.status_tarefa = 'open' and funcionario_executa.status_funcionario_tarefa = 'ativo' ";
        $query_verifica = mysqli_query($conexao_select_reabre, $query_verifica_registro);
        if (!$query_verifica) {
            $erro_select_reabre++;
        }
