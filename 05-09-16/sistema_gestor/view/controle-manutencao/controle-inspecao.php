<html>
    <head>
        ...
        <script src="../js/controle-manutencao/busca_manutencao_inspecao.js"></script>
    ...
    <body>
        ...
        <header class="row_controle-manutencao">
            <div class="row_controle">
                <div id="titulo_controle" class="col-sm-12 col-md-12 col-xs-12"><span>Cadastro de Veiculos no Controle de Manutenção por Inspeção</span></div>
            </div>
            <div id="menu_left">
                <div class="col-md-12 col-sm-12 col-xs-12" id="campo_veiculo">
                    <label class="col-md-2 col-sm-2 col-xs-2" >Veiculo</label>
                    <form  method="post" action="" class="form_manutencao_inspecao">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12"  style="margin:30px 0px 0px 5px;">
                    ...
                    <form  method="post" action="" class="form_controle">
                        <select class="col-md-4 col-sm-4" id="campo"  class="selectpicker" name="adiciona_atividade_controle" style="height: 30px;">
                            ...
                            $q_atividade_preventiva = "select atividades_controle.id_atividade_controle,atividades_controle.nome_atividade from atividades_controle where atividades_controle.tipo_atividade ='inspecao'";
