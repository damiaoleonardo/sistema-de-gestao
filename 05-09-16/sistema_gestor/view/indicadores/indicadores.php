...
//}
                    ...
                    include './indicadores/libchart/libchart/classes/libchart.php';
                    ...
                    $dataSet->addPoint(new Point("semana 34", 80));
                    $dataSet->addPoint(new Point("semana 35", 70));
                    $dataSet->addPoint(new Point("semana 36)", 90));
                     $dataSet->addPoint(new Point("semana 34", 80));
                    $dataSet->addPoint(new Point("semana 35", 70));
                    $dataSet->addPoint(new Point("semana 36)", 90));
                    $chart->setDataSet($dataSet);
                    $chart->setTitle("Indicador Semanal                                               Meta = 80");
                    $chart->render("./indicadores/libchart/demo/generated/$nome_imagem.png");
                    ?>
                    <img alt="Grafico de Pizza"  src="./indicadores/libchart/demo/generated/<?php echo $nome_imagem ?>.png" style="border: 1px solid gray;"/>
                </div>
            </div>
        </div>
    </body>
