...
<html>
    ...
    <body>
        ...
        <header>
                    ...
                    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
                        <div class="collapse navbar-collapse navbar-ex1-collapse" style="color: white; font-size:1.1em;">
                            <ul class="nav navbar-nav" style="margin-left: 0px; ">
                                ...
                                <li class="menu-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" style="font-size:1em; width: 180px;">
                                        ...
                                        <li class="menu-item dropdown dropdown-submenu">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="text-align: left; ">C. de Manutenção</a>
                                            <ul class="dropdown-menu" style="font-size:1em;"> 
                                                <li class="menu-item dropdown dropdown-submenu">
                                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Controle Manutenção</a>
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a href="telaPrincipal.php?t=controle-manutencao-preventiva">Manutenção Preventiva</a>
                                                        </li>
                                                        <li>
                                                            <a href="telaPrincipal.php?t=controle-manutencao-inspecao">Manutenção por Inspeção</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li style="text-align: left;"><a href="telaPrincipal.php?t=atividades-controle">Atividades Controle</a></li>                           
                                            </ul>
                                        </li>
                                        <li class="menu-item dropdown dropdown-submenu">
                                        ...
                                        <li class="menu-item dropdown dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu" style="font-size:1em;">
                                                ...
                                                <li class="menu-item " style="text-align: left;">
                                                    <a href="telaPrincipal.php?t=informacao-mes">Informacao do mês</a>
                                                </li> 
                                            </ul>
                                        </li>   
                                    </ul>
                                ...
                                <li class="menu-item dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color:white; font-size:1em;">Controle de Manutenção<b class="caret"></b></a>
                                    <ul class="dropdown-menu" style="font-size:1em; width: 180px;">
                                        <li><a href="telaPrincipal.php?t=controle-manutencao-preventiva-veiculos" style="text-align: left;"><span style="color:white; ">Preventiva</span></a></li>
                                        <li><a href="telaPrincipal.php?t=controle-manutencao-inspecao-veiculos" style="text-align: left;">Inspeção</a></li> 
                                    </ul>
                                </li>
                                <li><a href="telaPrincipal.php?t=sugestoes"><span style="color:white; ">Sugestões</span></a></li>
                                <li><a href="telaPrincipal.php?t=tabela_horas"><span style="color:white; ">Tabela horas</span></a></li>
                                <li class="menu-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" style="font-size:1em; width: 180px;">
                                        ...
                                        <li><a href="telaPrincipal.php?t=sugestoes-relatorio" style="text-align: left; ">Sugestoes</a></li> 
            ...
            } else if ($tabela == 'controle-manutencao-preventiva-veiculos') {
                ?>
                <div class="controle_manutencao"><?php require './controle-manutencao/controle_manutencao_preventiva.php'; ?></div><?php
            } else if ($tabela == 'atividades-controle') {
                ?>
                <div class="ativiades-controle"><?php require './controle-manutencao/atividades_controle.php'; ?></div><?php
            } else if ($tabela == 'controle-manutencao-preventiva') {
                ?>
                <div class="controle_manutencao"><?php require './controle-manutencao/controle-preventiva.php'; ?></div><?php
            }else if ($tabela == 'controle-manutencao-inspecao') {
                ?>
                <div class="controle_manutencao"><?php require './controle-manutencao/controle-inspecao.php'; ?></div><?php
            } else if ($tabela == 'sugestoes') {
                ?>
                <div class="sugestoes"><?php require './sugestoes/sugestoes.php'; ?></div><?php
            } else if ($tabela == 'tabela_horas') {
                ?>
                <div class="tabela_horas"><?php require './tabela_horas/tabela_horas.php'; ?></div><?php
            ...
            } else if ($tabela == 'sugestoes-relatorio') {
                ?>
                <div class="sugestoes-relatorio"><?php require './relatorios/sugestao/sugestao.php'; ?></div><?php
            ...
            } else if ($tabela == 'informacao-mes') {
                ?>
                <div class="informacao_mes"><?php require './informacoes_mes/informacoes_mes.php'; ?></div><?php
            } else {
                ?>
                <div class="tela_inicial"><?php require './tela_inicial/grafico_execucao.php'; ?></div><?php
            }
