<?php
if (isset($_GET['flag_veiculo'])) {
    $conexao_delete_veiculo = mysqli_connect("localhost", "root", "", "sistema_de_gestao");
    $erro_delete_veiculo = 0;
    $id_veiculo = $_GET['id_veiculo'];
    $sql_delete_veiculo = "delete from veiculos where veiculos.id_veiculo = $id_veiculo";
    if (!mysqli_query($conexao_delete_veiculo, $sql_delete_veiculo)) {
        $erro_delete_veiculo++;
    }
    if ($erro_delete_veiculo == 0) {
        mysqli_commit($conexao_delete_veiculo);
        echo "<script>alert('Veiculo excluida com sucesso!')</script>";
        echo "<script>location.href='../view/telaPrincipal.php?t=veiculos'</script>";
    } else {
        mysqli_rollback($conexao_delete_veiculo);
        echo "<script>alert('Erro ao excluir o veiculo!')</script>";
        echo "<script>location.href='../view/telaPrincipal.php?t=veiculos'</script>";
    }
}
?>
                        ...
                        <div class="col-sm-12 col-md-12 col-xs-12" style="margin-top:10px;" >
                            <div class="col-sm-12 col-lg-12" >
                                <div class="form-group">
                                    <label  class="col-md-3 control-label">Nome:</label>
                                    <div class="col-md-9">
                                        <input class="form-control" placeholder="Nome" value="<?php echo $nome_veiculo ?>" name="nome_atualiza" type="text">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-xs-12" style="margin-top:10px;">
                            <div class="col-sm-12 col-lg-12">
                                <div class="form-group">
                                    <label  class="col-md-3 control-label">Placa:</label>
                                    <div class="col-md-4">
                                        <input class="form-control" name="letras_atualiza" value="<?php echo $placas[0]; ?>" placeholder="XHF" type="text">
                                    </div>
                                    <div class="col-md-5">
                                        <input class="form-control" name="numeros_atualiza" value="<?php echo $placas[1]; ?>" placeholder="1234" type="text">
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-12 col-md-12 col-xs-12" style="margin-top:10px;">
                            <div class="col-sm-12 col-lg-12" >
                                <div class="form-group">
                                    <label  class="col-md-3 control-label">Tipo:</label>
                                    <div class="col-md-9" style="height: 35px; ;">
                                        <select class="selectpicker" name="tipo_veiculo_atualiza" style="width: 100%; height: 100%;">
